...
file_sources <- list.files("naomi/fielddatamonthly/functions", pattern="*.R", full.names = TRUE)
...
date_time_raw <- read_csv("data/Field_Data_Monthly_updated2.csv") %>%
...
init$outfilename <- "fluxdatamonthly_updated.csv"
init$pdffilename <- "fdm_updated10.pdf"
...
#-----------------------------------#
# read in dataframe
flux <- read_csv("output/fluxdatamonthly_updated.csv")
...
# export
write_csv(flux_full,"output/fluxdatamonthly_updated.csv")
